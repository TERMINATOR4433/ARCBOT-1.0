...
def TaskExe():
    ...
    Speak("how are you")
    def classic():
        Speak("startin beethoven 2022")
        os.startfile("C:\\Program Files\\ARCBOT\\Bassthoven (Animated Music Video w_ @King Science ).mp4")
    
    def BOT():
        os.startfile('./brinbt.py')

    def Music():
        Speak("Tell Me The NamE oF The Song!")
        musicName = takecommand()

        if 'iron man' in musicName:
            os.startfile('C:\\Program Files\\ARCBOT\\music\\music.mp3')
    ...
    def gui():
        ...
        Speak ("STARTING grapical user interface")
        
        os.system('python D:\\ARCBOT 1\\gui.py')
    ...
    def Reader():
        ...
        elif 'chapter 4' in name:
            os.startfile('C:\Program Files\ARCBOT\chap 4')
            book = open('C:\Program Files\ARCBOT\chap 4','rb')
            pdfreader = PyPDF2.PdfFileReader(book)
            pages = pdfreader.getNumPages()
            Speak(f"Number Of Pages In This Books Are {pages}")
            Speak("From Which Page I Have To Start Reading ?")
    ...
    def speedtest():
        ...
        correctDown = int(speed/800000)
        uploading = speed.upload()
        correctUpload = int(uploading/800000)


        if "uploading" in query:
            Speak('the upoading speed is') (correctUpload) ('mbps')
        
        if "downloading" in query:
            Speak('the upoading speed is')(correctDown)('mbps')
    ...
    while True:
        ...
        if 'hello' in query:
        ...
        elif 'Minecraft bot' in query:
            Speak('startin MinecraftBOT')
            BOT()
            ...
            remeberMsg = query.replace("remember","")
        ...
        elif ' do you have any remember' in query:
